...
equal(compile('<head><meta name="viewport" content="width=device-width, initial-scale=1"></head>')(), '<head><meta name="viewport" content="width=device-width, initial-scale=1"></head>')
...
equal(compile('<input value="">')(), '<input value="">')
equal(compile('<input class="">')(), '<input class="">')
