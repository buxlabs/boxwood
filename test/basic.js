...
equal(compile(`
<script translations>
  export default { submit: ['Wyślij', 'Send'] }
</script>
<div>{"submit" | translate}</div>`, { languages: ['pl', 'en'] })({ language: 'pl' }, html => html), `<div>Wyślij</div>`)

equal(compile(`
<script translations>
  export default { submit: ['Wyślij', 'Send'] }
</script>
<div>{"submit" | translate}</div>`, { languages: ['pl', 'en'] })({ language: 'en' }, html => html), `<div>Send</div>`)
