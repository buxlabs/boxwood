...
test('img: inline for png', async assert => {
  const template = await compile(`<img src='./placeholder.png' inline>`, { paths: [path.join(__dirname, '../../fixtures/images')] })
...
test('img: inline for jpg', async assert => {
  const template = await compile(`<img src='./placeholder.jpg' inline>`, { paths: [path.join(__dirname, '../../fixtures/images')] })
...
test.skip('img: inline for svg', async assert => {
...
test('img: global inline for png', async assert => {
  const template = await compile(`<img src='./placeholder.png'>`, { paths: [ path.join(__dirname, '../../fixtures/images') ], inline: ['images'] })
  assert.deepEqual(template({}, escape), `<img src="data:image/png;base64, ">`)
})

test('img: global inline for jpg', async assert => {
  const template = await compile(`<img src='./placeholder.jpg'>`, { paths: [ path.join(__dirname, '../../fixtures/images') ], inline: ['images'] })
  assert.deepEqual(template({}, escape), `<img src="data:image/jpg;base64, ">`)
})
