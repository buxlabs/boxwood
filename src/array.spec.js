...
// assert.deepEqual(normalize(['or']), '')
// assert.deepEqual(normalize(['and']), '')
// assert.deepEqual(normalize(['eq']), '')
// assert.deepEqual(normalize(['neq']), '')
// assert.deepEqual(normalize(['does', 'not', 'equal']), '')
// assert.deepEqual(normalize(['is', 'not', 'equal', 'to']), '')
...
// assert.deepEqual(normalize(['is', 'less', 'than']), '')
...
// assert.deepEqual(normalize(['is', 'less', 'than', 'or', 'equals']), '')
